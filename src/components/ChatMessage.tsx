    ...
    <div className={`flex gap-3 mb-6 ${message.type === 'user' ? 'justify-end' : 'justify-start'}`}>
      {message.type === 'bot' && (
        <div className="flex-shrink-0">
          <div className="w-8 h-8 rounded-full bg-gradient-hero flex items-center justify-center netflix-glow">
      ...
      <div className={`max-w-4xl ${message.type === 'user' ? 'order-1' : ''}`}>
        <div className={`glass-card p-4 ${message.type === 'user' ? 'bg-primary/20' : ''}`}>
